...
return array(
    ...
    'equals'         => "должен совпадать с полем '%s'",
    ...
    'email'          => "не является валидным E-Mail адресом",
    'url'            => "не является валидной ссылкой",
    'urlActive'      => "содержит не активную ссылку",
    'alpha'          => "должно содержать только латинские символы",
    'alphaNum'       => "должен содержать только латинские символы и/или цифры",
    'ascii'          => "должен содержать только латиницу и спец. символы",
