    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <?php if ($query != null): ?>
            ...
            <div class="tab-content fix">
              <div id="grid-view" class="tab-pane active">
                <div class="row">
                  ...
                  <?php endforeach;?>
                  <?php else:?>
                    <h5 class="search_div" style="margin-left:15px">По запросу '<?=h($query);?>' ничего не найдено :(</h5>
                  <?php endif;?>
                </div>
              </div>
              <!-- #grid view End -->
              <div id="list-view" class="tab-pane">
                ...
                <?php endforeach;?>
                <?php else:?>
                  <h5>По запросу '<?=h($query);?>' ничего не найдено :(</h5>
                <?php endif;?>
              </div>
              <!-- #list view End -->
            </div>
          ...
          <?php endif;?>
          <?php else: ?>
            <h4>Введите запрос в поисковом окне</h4>
          <?php endif;?>
