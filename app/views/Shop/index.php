                ...
                <div class="grid-list-top border-default universal-padding fix mb-30">
                    <div class="grid-list-view f-left">
                        <ul class="list-inline nav">
                            ...
                            <li><span class="grid-item-list"> Товара (ов) <?=count($products);?> из <?=$count;?></span></li>
                        </ul>
                    </div>
                </div>
                <!-- Grid & List View End -->
                    ...
                    <div class="tab-content fix">
                        <div id="grid-view" class="tab-pane active">
                            <div class="row">
                                            ...
                                            <div class="single-product" style="height: 390px">
                                                ...
                                                <div class="pro-content">
                                                    <div class="rating_star" style="left: 30%; position: relative; line-height: 0.75;">
                                                        <?php ratingForArray($product); ?>
                                                    </div>
                                                </div>
                                                <h4 style="margin-top: 10px"><a href="product/<?= $product['alias'];?>"><?=$product['title'];?></a></h4>
                                                <div class="price_new"><?php priceForArray($product, $curr);?></div>
                                ...
                                <?php endforeach;?>
                                <?php else:?>
                                    <h5 class="search_div" style="margin-left:15px">К сожалению товаров ещё не нет :(</h5>
                                <?php endif;?>
                            </div>
                        </div>
                        <!-- #grid view End -->
                            ...
                            <?php if (!empty($products)):?>
                                <?php foreach ($products as $product) :?>
                                    ...
                                    <div class="single-product">
                                        ...
                                        <h4 style="margin-top: 10px"><a href="product/<?= $product['alias'];?>"><?= $product['title'];?></a></h4>
                                        <?php priceForArray($product, $curr);?>
